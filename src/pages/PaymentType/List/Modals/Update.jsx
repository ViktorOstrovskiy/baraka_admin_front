...
import {createPaymentType, updatePaymentType} from "../../action.js";
...
const ModalUpdate = ({ isOpen, closeModal, workType, loadData, create }) => {
    ...
    const handleClickSave = async () => {
        ...
        if(!create) {
            ...
            const resp = await updatePaymentType(id, options)
        ...
        if(create) {
            ...
            const resp = await createPaymentType(options)
    ...
    return (
        <Modal
            isOpen={isOpen}
            onClose={closeModal}
            title={`${create ?'Create' :'Edit'} Payment Type`}
        >
